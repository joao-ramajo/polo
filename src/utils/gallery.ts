...
export function getGalleryTileClasses(shape: TattooLayoutHint): string {
  switch (shape) {
    case "wide":
      return "aspect-[16/10] lg:col-span-7 lg:row-span-3";
    case "landscape":
      return "aspect-[4/3] lg:col-span-6 lg:row-span-3";
    case "square":
      return "aspect-square lg:col-span-4 lg:row-span-4";
    case "tall":
      return "aspect-[3/5] lg:col-span-3 lg:row-span-5";
    case "portrait":
    default:
      return "aspect-[4/5] lg:col-span-4 lg:row-span-5";
  }
}
